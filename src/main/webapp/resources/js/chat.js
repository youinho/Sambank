...
if(TaitL=="SamBanK"){TaitLLink=mainServerUrl;}
else{TaitLLink='#';}
_T$Ha.innerHTML='\
...
_T$Ha.innerHTML='<div id="TpTbw" style="'+_T$Ga+'border:none; position:absolute; top:140px;">'+lc+'</div>';if(_T$fa){_T$hb(_T$sb,"pointer");}}
