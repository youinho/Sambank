...
$(function(){
	...
	$("#go-list").click(function(){
		...
		$("#myForm").attr("action","/admin/customer_notice");
	...
	$("#go-delete").click(function(){
		...
		$("#myForm").attr("action", "/admin/customer_notice/delete");
	...
	$("#go-modify").click(function(){
		...
		$("#myForm").attr("action", "/admin/customer_notice/modify");
	...
	$.ajax({
		url : '/admin/customer_notice/get_attachList',
		beforeSend : function(xhr)
        {   
            xhr.setRequestHeader(hn, tk);
        },
	...
	$("#fileBlock").on("click", "div", function(){
			...
			self.location="/admin/customer_notice/downloadFile?fileName="+fileName+"&uuid="+li.data("uuid");
