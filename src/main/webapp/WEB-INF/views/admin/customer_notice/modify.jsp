...
$(function(){
	...
	$("#cancel").click(function(e){
		...
		$("#modForm").attr("action","/admin/customer_notice/read/"+"${vo.notice_bno}");
...
<div class="col-md-10">     
	<form action="/admin/customer_notice/modify" method="post" id="modForm">   
...
$(function(){
	...
	$("input[type='file']").change(function(){
		...
		$.ajax({
			url : '/admin/customer_notice/upload',
			processData : false,
			contentType : false,
			beforeSend : function(xhr)
            {   
	...
	$(".uploadResult").on("click","button", function(){
		...
		$.ajax({
			url : '/admin/customer_notice/deleteFile',
			dataType : 'text',
			beforeSend : function(xhr)
            {   
                xhr.setRequestHeader(hn, tk);
