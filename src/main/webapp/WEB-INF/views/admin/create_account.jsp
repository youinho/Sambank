...
function searchCS_callback(cno){
		...
		$.ajax({
			...
			success : function(result){
				...
				str = "<div role='separator' class='dropdown-divider'></div>";
	...
	<form action="" method="post" id="createForm">
		...
		<tr>
			...
			<div class="input-group">
			  <div class="input-group-prepend text-center" style="width:15%">
			    <span class="input-group-text" style="width:100%">고객 정보</span>
			  </div>
			...
			<td>
				<div class="input-group">
				  <div class="input-group-prepend" style="width:15%">
				    <span class="input-group-text" style="width:100%">상품</span>
				  </div>
		...
		<tr>
			<td>
				<div class="input-group">
				  <div class="input-group-prepend" style="width:15%">
				    <span class="input-group-text" style="width:100%">계좌번호</span>
				  </div>
		...
		<tr>
			...
			<div class="input-group">
			  <div class="input-group-prepend" style="width:15%">
			    <span class="input-group-text" style="width:100%">이체 한도</span>
			  </div>
		...
		<tr>
			...
			<div class="input-group">
			  <div class="input-group-prepend" style="width:15%">
			    <span class="input-group-text" style="width:100%">비밀번호 </span>
			  </div>
