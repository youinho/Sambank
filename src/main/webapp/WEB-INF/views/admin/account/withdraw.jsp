...
function alert_success(){
	...
	if(success != "" && success != null){
		if(success=="true"){
			alert("${ano}계좌에서  ${amount}원이 출금되었습니다.");
...
<div class="col-md-12">
	<div class="col-md-12">
		<h3 class="page-header title">출금</h3>
	</div>
	<form action="" method="post" id="withdrawForm">
		...
		<tr>
			...
			<div class="input-group">
			  <div class="input-group-prepend" style="width:15%">
			    <p class="input-group-text" style="width:100%"><strong>출금액</strong></p>
			  </div>
...
<script src="/resources/js/admin/account/admin_withdraw.js"></script>